 ...
 */
function theme_ioc_clean_process_css($css, $theme) {

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_ioc_clean_set_logo($css, $logo);
    ...
    $css = theme_ioc_clean_set_customcss($css, $customcss);
 ...
 */
function theme_ioc_clean_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 */
function theme_ioc_clean_set_customcss($css, $customcss) {
 ...
 */
function theme_ioc_clean_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
 ...
 */
function ioc_clean_process_css() {
 ...
 * @deprecated since 2.5.1
 */
function ioc_clean_set_customcss() {
    throw new coding_exception('Please call theme_'.__FUNCTION__.' instead of '.__FUNCTION__);
}
